...
{
    public sealed class CatalogoIntegrationHandler : BackgroundService
    {
        ...
        private void SetSubscribers()
        {
            _bus.SubscribeAsync<PedidoAutorizadoIntegrationEvent>("PedidoAutorizado", async request =>
                await BaixarEstoqueAsync(request));
        }

        private async Task BaixarEstoqueAsync(PedidoAutorizadoIntegrationEvent message)
        {
