...
namespace NSE.Pagamentos.API.Facede
{
    public class PagamentoCartaoCreditoFacade : IPagamentoFacade
    {
        ...
        public async ValueTask<Transacao> AutorizarPagamentoAsync(Pagamento pagamento)
        {
        ...
        public async ValueTask<Transacao> CapturarPagamentoAsync(Transacao transacao)
        {
            var nerdsPagSvc = new NerdsPagService(_pagamentoConfig.DefaultApiKey,
                _pagamentoConfig.DefaultEncryptionKey);
        ...
        public async ValueTask<Transacao> CancelarAutorizacaoAsync(Transacao transacao)
        {
            var nerdsPagSvc = new NerdsPagService(_pagamentoConfig.DefaultApiKey,
                _pagamentoConfig.DefaultEncryptionKey);
